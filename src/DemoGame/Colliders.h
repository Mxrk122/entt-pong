        ...
        for (size_t i = 0; i < entityCount; ++i) {
            ...
            for (size_t j = i + 1; j < entityCount; ++j) {
                ...
                if (checkCollision(pos1, col1, pos2, col2)) {
                    std::cout << "Collision detected between entities " << static_cast<int>(e1) << " and " << static_cast<int>(e2) << "\n";
    ...
    void run(float dT) {
        ...
        for (size_t i = 0; i < entityCount; ++i) {
            ...
            for (auto enemyEntity : enemyView) {
                ...
                if (checkCollision(pos1, col1, enemyPos, enemyComp)) {
                    std::cout << "Collision detected between entity " << static_cast<int>(e1) << " and enemy\n";
        ...
        for (auto e : entitiesToDestroy) {  
            ...
            if (enemyComp.isDestroyed) {
                enemySpr.width = 0;
                enemySpr.height = 0;
                std::cout << "Enemy " << static_cast<int>(e) << " destroyed\n";
            }
        }
    }
